  ...
  chapters: [
    // ── Chapter 1: Peor que un hombre lobo es la menta granizada ───
    {
      ...
      battleScript: [
        ...
        { turn: 'enemy', text: 'El helado congela a toda la party.', damage: 5 },
    ...
    // ── Chapter 2: Atacando al system ──────────────────────────────
    {
      ...
      battleScript: [
        ...
        { turn: 'enemy', text: 'La Banana les tira relleno caliente.', damage: 10 },
    ...
    // ── Chapter 3: Los vampiros de Zar'Ate ──────────────────────────
    {
      ...
      battleScript: [
        ...
        { turn: 'enemy', text: 'El Mosquito los pica a todos.', damage: 15 },
    ...
    // ── Chapter 4: La base en Ram'Os ─────────────────────────────
    {
      ...
      battleScript: [
        ...
        { turn: 'enemy', text: 'El Golem lanza un splash tóxico de mugre a toda la party.', damage: 10 },
    ...
    // ── Chapter 5: Dulces recompensas ──────────────────────────────
    {
      ...
      battleScript: [
        ...
        { turn: 'enemy', text: 'El fantasma ataca a la party con un pico de glucosa mágica.', damage: 15 },
    ...
    // ── Chapter 6: La nueva Base en Tab'ladah ─────────────────────
    {
      ...
      battleScript: [
        ...
        { turn: 'enemy', text: 'Lanza un chorro de ketchup radiactivo a toda la party.', damage: 20 },
    ...
    // ── Chapter 7: Hospital Militar ───────────────────────────────────
    {
      ...
      enemy: { id: 'militar', name: 'Enfermera Severus', emoji: '👩‍⚕️', spriteId: 'militar', hp: 55, maxHp: 55, color: '#e74c3c', imageUrl: 'assets/militar.png', flip: true, defeatText: '¡La Enfermera Severus fue derrotada!' },
      battleScript: [
        { turn: 'player', text: '¡Atacan con paciencia y mucho amor!', damage: 25 },
        { turn: 'enemy', text: 'La enfermera ataca a toda la party con luz azul y pesadas reglas.', damage: 15 },
    ...
    // ── Chapter 8: La aventura congelada ───────────────────────────
    {
      ...
      introDialogues: [
        ...
        { name: 'Margarita', text: '¡Como pícara berserker, el frío solo aumenta mi furia!', portrait: '🤸‍♀️', color: '#e67e22' },
      ...
      battleScript: [
        ...
        { turn: 'enemy', text: 'El Yeti ruge creando una ventisca sobre la party.', damage: 25 },
      ...
      resolutionDialogues: [
        ...
        { name: 'Narrador', text: 'Obtuvieron: Orbe de buenos recuerdos', portrait: '🔮', color: '#0984e3' },
        { name: 'Orbe de Recuerdos', text: '✨ Orbe de buenos recuerdos: una aventura congelada (y no es frozen) ✨', portrait: '✨', color: '#74b9ff', textColor: '#74b9ff' }
      ],
      allyIndex: null,
      allyDialogues: null
    },
    ...
    // ── Chapter 9: Rey Gato ────────────────────────────────────────
    {
      ...
      battleScript: [
        ...
        { turn: 'enemy', text: 'Zarpazo real de desdén absoluto a toda la party.', damage: 10 },
    ...
    // ── Chapter 10: Igua'zu (cinematic) ──────────────────────────
    {
      ...
      introDialogues: [
        ...
        { name: 'Narrador', text: 'Al acostumbrar su vista, en el cielo nocturno aparece la Luna Oracular.', portrait: '🌙', color: '#dfe6e9' },
        { name: 'Narrador', text: 'El camino recorrido los ha traído hasta aquí...', portrait: '📖', color: '#a29bfe' },
        { name: 'Narrador', text: 'La luna les revela que su destino es encontrar al Cerezo milenario.', portrait: '🌙', color: '#dfe6e9' }
      ],
      enemy: null,
      battleScript: [],
      resolutionDialogues: [
    ...
    // ── Chapter 11: BOSS – El Cerezo Milenario ──────────────────────────
    {
      ...
      particleType: 'hearts',
      introDialogues: [
        { name: 'Narrador', text: 'Tras seguir el brillo de la luna, finalmente encuentran al Cerezo Milenario en el centro del jardín.', portrait: '🌸', color: '#fd79a8' },
        { name: 'El Cerezo Milenario', text: '¡Bienvenidos, viajeros de la vida!', portrait: '🌸', color: '#fd79a8' },
        { name: 'El Cerezo Milenario', text: 'Muéstrenme los orbes de sus recuerdos para bendecir su unión con los anillos sagrados.', portrait: '🌸', color: '#fd79a8' }
      ],
      ...
      battleScript: [
        ...
        { turn: 'player', text: '¡Le ofrecen el Orbe de buenos recuerdos: una aventura congelada (y no es frozen)!', damage: 15 },
