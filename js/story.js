export const STORY = {
  chapters: [
    ...
    // ── Chapter 5: Cap. 5: Dulce Recompensa ──────────────────────────────
    {
      ...
      enemy: { id: 'diabetologa', name: 'Médica de Maná', emoji: '👩‍⚕️', spriteId: 'hospital', hp: 60, maxHp: 60, color: '#3498db', projEmoji: '🍬', imageUrl: 'assets/diabetologa.png', flip: true, defeatText: '¡La Médica de Maná fue derrotada!' },
      battleScript: [
    ...
    // ── Chapter 7: Cap. 7: Amor Amarillo ───────────────────────────────────
    {
      ...
      enemy: { id: 'militar', name: 'Enfermera Serverus', emoji: '👩‍⚕️', spriteId: 'militar', hp: 55, maxHp: 55, color: '#e74c3c', projEmoji: '💊', imageUrl: 'assets/militar.png', flip: true, defeatText: '¡La Enfermera Serverus fue derrotada!' },
      battleScript: [
    ...
    // ── Chapter 8: Cap. 8: Aventura Congelada ───────────────────────────
    {
      ...
      particleType: 'snow',
      introDialogues: [
        { name: 'Narrador', text: 'Viviana la maga, Gastón el bárbaro, Valentina la druida y Margarita la pícara berserker se preparan para una aventura en las laderas nevadas de la cordillera Andin, que separa Chill\'e y Argent\'ina.', portrait: '📖', color: '#a29bfe' },
    ...
    // ── Chapter 10: Cap. 10: Luna Oracular ──────────────────────────
    {
      num: 10,
      title: 'Cap. 10: Luna Oracular',
      bgClass: 'bg-tablada',
      melody: 'mistica',
      particleType: 'stars',
      ...
      introDialogues: [
        ...
        { name: 'Narrador', text: 'Atravesaron la selva espesa solo guiados por la luz lunar. Al acostumbrar su vista, vieron la sombra de un Leviatán en los ríos, pájaros azules brillantes y los ojos de un yaguarundí.', portrait: '📖', color: '#a29bfe' },
        ...
        { name: 'Diosa Selenita', text: 'Llegaron hasta acá después de muchas aventuras. Para poder pasar de nivel deben encontrar al Cerezo milenario.', portrait: '🌙', color: '#dfe6e9' },
    ...
    // ── Chapter 11: Cap. 11: El Cerezo milenario ──────────────────────────
    {
      ...
      particleType: 'hearts',
      introDialogues: [
        { name: 'Narrador', text: 'Los 4 viajeros, más el Rey Gato fueron a encontrar al Cerezo milenario.', portrait: '🌸', color: '#fd79a8' },
